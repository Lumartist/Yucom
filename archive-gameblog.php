...
<div class="column-group">
    ...
    <?php
        ...
        $args = array( 'post_type' => array('gameblog'), 'orderby'=>'date', 'order'=>'DESC', 'posts_per_page' => 12, 'paged' => $paged);
                        ...
                        <div class="xlarge-33 large-33 medium-33 small-100 tiny-100 wow flipInX animated">
                            <div class="blog_item blog_main_news">
                                ...
                                <a class="blog_item_link tiptop" data-tip-text="News lesen" href="<?php the_permalink() ?>">
                                    <h5><?php the_title(); ?></h5>
                                    <p><span class="item_flag_konsole"><?php echo wp_html_excerpt( get_the_excerpt() , 110, ' [...]'); ?></span></p>
                                </a>
                            </div>
                        </div>
                        <!-- /Blog Item -->
        ...
        <div class="xlarge-50 large-50 medium-50 small-100 tiny-100">
            <nav class="ink-navigation blog_archive">
                <ul class="pagination pills black">
                    ...
                    <li data-tip-text="Archiv aller Einträge" class="tiptop"><a href="#">Alle</a></li>
                    <li data-tip-text="MMO News Archiv" class="tiptop"><a href="#">MMO</a></li>
                    <li data-tip-text="PC News Archive" class="tiptop"><a href="#">PC</a></li>
                    <li data-tip-text="Konsolen News Archiv" class="tiptop"><a href="#">Konsole</a></li>
                    <li data-tip-text="Offtopic News archiv" class="tiptop"><a href="#">OT</a></li>
                </ul>
            </nav>
        </div>
