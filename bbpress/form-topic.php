...
<?php if ( bbp_current_user_can_access_create_topic_form() ) : ?>
	...
	<div id="new-topic-<?php bbp_topic_id(); ?>" class="bbp-topic-form">
		...
		<form id="new-post" class="ink-form" name="new-post" method="post" action="<?php the_permalink(); ?>">
			...
			<div class="bbp-form">
				...
				<a id="new"></a>
				<div class="forum_reply_title clearfix"><span>Thema erstellen</span></div>
                <div class="topic_form_reply">
					...
					<?php do_action( 'bbp_theme_before_topic_form_title' ); ?>
                        ...
                        <div class="control-group">
                            ...
                            <div class="control">
                                <input type="text" placeholder="Maximal 80 Zeichen" id="bbp_topic_title" value="<?php bbp_form_topic_title(); ?>" tabindex="<?php bbp_tab_index(); ?>" size="40" name="bbp_topic_title" maxlength="<?php bbp_title_max_length(); ?>">
                            </div>
                        </div>
					...
					<?php /* bbp_the_content( array( 'context' => 'topic' ) ); */ ?>
                        ...
                        <label for="bbp_topic_text"><?php _e( 'Text', 'bbpress' ); ?></label>
					...
					<?php if ( bbp_allow_topic_tags() && current_user_can( 'assign_topic_tags' ) ) : ?>
						...
						<div class="control-group">
                            ...
                            <div class="control">
                                <input placeholder="Topic-Tags, durch Komma trennen" type="text" value="<?php bbp_form_topic_tags(); ?>" tabindex="<?php bbp_tab_index(); ?>" size="40" name="bbp_topic_tags" id="bbp_topic_tags" <?php disabled( bbp_is_topic_spam() ); ?>>
                            </div>
                        </div>
					...
					<div class="bbp-sub-wrapper">

						<?php do_action( 'bbp_theme_before_topic_form_submit_button' ); ?>
						
						<button type="submit" tabindex="<?php bbp_tab_index(); ?>" id="bbp_topic_submit" name="bbp_topic_submit" class="ink-button blue">Erstellen</button>
...
<?php else : ?>
    ...
    <div id="no-topic-<?php bbp_topic_id(); ?>" class="ink-alert basic" role="alert">
        <p><b>Achtung:</b> <?php is_user_logged_in() ? _e( 'You cannot create new topics.', 'bbpress' ) : _e( 'Um neue Themen zu verfassen musst du angemeldet sein!', 'bbpress' ); ?></p>
    </div>
