                            ...
                            <div class="selector">
                                ...
                                <nav class="ink-navigation">
                                    <ul class="pagination pills black">
                                        <li><a class="tiptop" data-tip-text="Springe zum Bereich Gameblog" href="#" onclick="$('#blog').animatescroll();">Gameblog</a></li>
                                        <li><a class="tiptop" data-tip-text="Springe zum Bereich Community" href="#" onclick="$('#community').animatescroll();">Community</a></li>
                                        <li><a class="tiptop" data-tip-text="Springe zum Bereich Gilde" href="#" onclick="$('#guild').animatescroll();">Gilde</a></li>
                                    </ul>
                                </nav>
                            </div>
                        </div>
...
<!-- /Header -->
<!-- Carousel -->
<div class="ink-grid" id="blog">
    <div class="column-group">    
        <div class="xlarge-100 large-100 medium-100 small-100 tiny-100 carousel">
            <div class="clearfix">
                <div class="carousel_lft">
                    <a class="carousel_prev"><i class="fa fa-angle-double-left"></i></a>  
                </div>
                <div id="featured">
                ...
                <div class="carousel_rgt">
                    <a class="carousel_next"><i class="fa fa-angle-double-right"></i></a>  
                </div>
            </div>
        </div>
    </div>
