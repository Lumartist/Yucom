...
<div class="column-group">
    ...
    <?php
        ...
        $args = array( 'post_type' => array('gameblog'), 'orderby'=>'date', 'order'=>'DESC', 'posts_per_page' => 12, 'paged' => $paged, 'kategorien' => 'pc');
                        ...
                        <div class="xlarge-33 large-33 medium-33 small-100 tiny-100 wow flipInX animated">
                            <div class="blog_item blog_main_news">
                                ...
                                <a class="blog_item_link tiptop" data-tip-text="News lesen" href="<?php the_permalink() ?>">
                                    <h5><?php the_title(); ?></h5>
                                    <p><span class="item_flag_pc"><?php echo wp_html_excerpt( get_the_excerpt() , 110, ' [...]'); ?></span></p>
                                </a>
                            </div>
                        </div>
                        <!-- /Blog Item -->
