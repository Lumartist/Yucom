                            <?php              
                                $args = array( 'post_type' => array('reviewer'), 'orderby'=>'date', 'order'=>'DESC', 'posts_per_page' => 3 );
                            ...
                            <div class="clearfix article_item wow animated flipInX">
                                <div class="article_image">
                                    <figure class="ink-image">
                                        ...
                                        <figcaption class="over-top">
                                            <div class="article_flag_<?php $terms = get_the_terms( $post->ID, 'art' ) ;
                                                ...
                                                echo $str              
                                            ?>"><?php
                                                $terms = get_the_terms( $post->ID, 'art' ) ;
                                                $term_list = array_pop($terms)->name ;
                                                foreach( $terms as $os )
                                                {
                                                    $term_list .= ", " . $os->name ;
                                ...
                                <div class="article_info">
                                    <a class="article_item_link tiptop" data-tip-text="Artikel lesen" href="<?php the_permalink() ?>">
                                        <h5><?php the_title(); ?></h5>
                                        <p><span class="item_flag_<?php $terms = get_the_terms( $post->ID, 'art' ) ;
                                                $term_list = array_pop($terms)->name ;
                                                foreach( $terms as $os )
                                                {
                                                    $term_list .= ", " . $os->name ;
