                            <div class="sidebar_main_title clearfix"><span style="float:left;">Beliebte News</span><a class="main_title_link" href="">Archiv</a></div>
                                
                            <?php              
                                $args = array( 'post_type' => array('gameblog'), 'orderby'=>'comment_count', 'order'=>'DESC', 'posts_per_page' => 4 );
                            ...
                            <div class="clearfix article_item wow animated flipInX">
                                <div class="article_image">
                                    <figure class="ink-image">
                                        ...
                                        <figcaption class="over-top">
                                            <div class="article_flag_<?php $terms = get_the_terms( $post->ID, 'kategorien' ) ;
                                ...
                                <div class="article_info">
                                    <a class="article_item_link tiptop" data-tip-text="News lesen" href="<?php the_permalink() ?>">
                                        <h5><?php the_title(); ?></h5>
